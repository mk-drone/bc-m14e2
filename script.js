...
let moviesElements = movies.map((movie) => {
    //czy style w react powinny być tworzone klasycznie przy pomocy osobnego pliku css?
    //jeśli tak, to kiedy warto lub zalecane jest uzycie inline style tak jak w przypadku paragrafu z linii 29
